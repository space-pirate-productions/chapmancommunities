...
function chapman_customize($wp_customize)
{
  ...
  $wp_customize->add_setting('nav_button_new_tab');
  $wp_customize->add_control('nav_button_new_tab', array(
    'label' => 'Open in new tab.',
    'description' => 'Check the box to have the button open in a new browser tab.',
    'section' => 'title_tagline',
    'type' => 'checkbox',
  ));
  $wp_customize->get_setting('nav_button_url')->transport = 'postMessage';
